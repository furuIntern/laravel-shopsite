...
<head>
    ...
    <title><?php echo e(Facades\App\Services\Setting\UseSetting::title()); ?></title>
        ...
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container">
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                    <img class="logo" src="<?php echo e(asset('storage/logo.png')); ?>" alt="" srcset="">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item dropdown">
                                    <a data-id="<?php echo e($parent->id); ?>" class="nav-link category" href=""><?php echo e($parent->name); ?></a>
...
<?php /**PATH D:\Training\Laravel\shop-site\resources\views/layouts/app.blade.php ENDPATH**/ ?>